...
def main() -> None:
    ...
    with zipfile.ZipFile(args.apk) as apk:
        ...
        required = {
            ...
            "assets/assets/data/safety-week4.json",
        ...
        safety_week_4 = json.loads(apk.read("assets/assets/data/safety-week4.json"))
        assert safety_week_4["title"] == "第四周安规考试"
        assert len(safety_week_4["questions"]) == 270
        assert len(safety_week_4["chapters"]) == 18
        for chapter in safety_week_4["chapters"]:
            for kind in ("single", "fill", "judge"):
                assert sum(q["chapter"] == chapter and q["type"] == kind for q in safety_week_4["questions"]) == 5
        ...
        assert b'"id":"safetyweek4"' in embedded

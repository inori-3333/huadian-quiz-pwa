...
const files = ['index.html', 'styles.css', 'core.js', 'exam.js', 'main.js', 'pwa.js', 'banks-data.js', 'regulations-data.js', 'short-answers.js', 'manifest.webmanifest', 'assets/icon.svg', 'assets/icon.png', 'assets/icon-192.png', 'assets/group-15.jpg']
...
const payloads = files.map(file => {
  ...
  if (!/\.(png|jpg)$/.test(file)) data = Buffer.from(data.toString().replace(/\r\n/g, '\n'))
